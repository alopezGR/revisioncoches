...
class Pegatinas extends Vehiculo
{
    ...
    private static function insertarPegatinasExteriorFrontal($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_ext_frontal` (`ID`, `CRTM_LOGO`, `LOGO_EMPRESA`, `MINUSVALIDO`, `NUMERO_VEHICULO`, `CRTM_LOGO_OBS`, 
        `LOGO_EMPRESA_OBS`, `MINUSVALIDO_OBS`, `NUMERO_VEHICULO_OBS`) VALUES (NULL, :CRTM_LOGO, :LOGO_EMPRESA, :MINUSVALIDO, :NUMERO_VEHICULO, :CRTM_LOGO_OBS, 
        :LOGO_EMPRESA_OBS, :MINUSVALIDO_OBS, :NUMERO_VEHICULO_OBS)";
    ...
    private static function insertarPegatinasExteriorLateralDerecho($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_ext_lateral_derecho` (`ID`, `LOGO_EMPRESA`, `WEB_CRTM`, `PMR`, `STOP_COVID`, `SALIDA`, 
        ...
        `CAMARA_COMERCIO_OBS`, `SALIDA_EMERGENCIA_OBS`, `GRUPO_RUIZ_OBS`, `NUMERO_VEHICULO_OBS`, `APRTURA_EMERGENCIA_OBS`, `SOLICITUD_RAMPA_OBS`) 
        VALUES (NULL, :LOGO_EMPRESA, :WEB_CRTM, :PMR, :STOP_COVID, :SALIDA, :ENTRADA, :MINUSVALIDO, :CAMARA_COMERCIO, :SALIDA_EMERGENCIA, :GRUPO_RUIZ, 
         ...
         :CAMARA_COMERCIO_OBS, :SALIDA_EMERGENCIA_OBS, :GRUPO_RUIZ_OBS, :NUMERO_VEHICULO_OBS, :APERTURA_EMERGENCIA_OBS, :SOLICITUD_RAMPA_OBS)";
    ...
    private static function insertarPegatinasExteriorLateralIzquierdo($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_ext_lateral_izq` (`ID`, `CRTM_LOGO`, `LOGO_EMPRESA`, `WEB_CRTM`, `CAMARA_COMERCIO`, 
        `SALIDA_EMERGENCIA`, `GRUPO_RUIZ`, `NUMERO_VEHICULO`, `CRTM_LOGO_OBS`, `LOGO_EMPRESA_OBS`, `WEB_CRTM_OBS`, 
        `CAMARA_COMERCIO_OBS`, `SALIDA_EMERGENCIA_OBS`, `GRUPO_RUIZ_OBS`, `NUMERO_VEHICULO_OBS`) 
        VALUES (NULL, :CRTM_LOGO, :LOGO_EMPRESA, :WEB_CRTM, :CAMARA_COMERCIO, :SALIDA_EMERGENCIA, :GRUPO_RUIZ, :NUMERO_VEHICULO, 
        :CRTM_LOGO_OBS, :LOGO_EMPRESA_OBS, :WEB_CRTM_OBS, :CAMARA_COMERCIO_OBS, :SALIDA_EMERGENCIA_OBS, :GRUPO_RUIZ_OBS, :NUMERO_VEHICULO_OBS)";
    ...
    private static function insertarPegatinasLunaExteriorTrasera($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_ext_lunas` (`ID`, `SALIDA_EMERGENCIA`, `GRUPO_RUIZ`, `SALIDA_EMERGENCIA_OBS`, 
        `GRUPO_RUIZ_OBS`) VALUES (NULL, :SALIDA_EMERGENCIA, :GRUPO_RUIZ, :SALIDA_EMERGENCIA_OBS, :GRUPO_RUIZ_OBS)";
    ...
    private static function insertarPegatinasExteriorTrasero($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_ext_trasera` (`ID`, `CRTM_LOGO`, `LOGO_EMPRESA`, `WEB_CRTM`, `WEB_EMPRESA`, `NUMERO_VEHICULO`, 
        `SALIDA_EMERGENCIA`, `CRTM_LOGO_OBS`, `LOGO_EMPRESA_OBS`, `WEB_CRTM_OBS`, `WEB_EMPRESA_OBS`, `NUMERO_VEHICULO_OBS`, `SALIDA_EMERGENCIA_OBS`) 
        VALUES (NULL, :CRTM_LOGO, :LOGO_EMPRESA, :WEB_CRTM, :WEB_EMPRESA, :NUMERO_VEHICULO, :SALIDA_EMERGENCIA, 
        :CRTM_LOGO_OBS, :LOGO_EMPRESA_OBS, :WEB_CRTM_OBS, :WEB_EMPRESA_OBS, :NUMERO_VEHICULO_OBS, :SALIDA_EMERGENCIA_OBS)";
    ...
    private static function insertarPegatinasInteriorDelantero($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_int_del` (`ID`, `VIDEOVIGILANCIA`, `PROHIBIDO_FUMAR`, `PTM`, `CAMBIO_MAXIMO`, 
        `TARIFAS`, `OCUPACION_MAXIMA`, `BOTIQUIN`, `SALIDA_EMERGENCIA`, `VIDEOVIGILANCIA_OBS`, `PROHIBIDO_FUMAR_OBS`, 
        `PTM_OBS`, `CAMBIO_MAXIMO_OBS`, `TARIFAS_OBS`, `OCUPACION_MAXIMA_OBS`, `BOTIQUIN_OBS`, `SALIDA_EMERGENCIA_OBS`) 
        VALUES (NULL, :VIDEOVIGILANCIA, :PROHIBIDO_FUMAR, :PTM, :CAMBIO_MAXIMO, :TARIFAS, :OCUPACION_MAXIMA, :BOTIQUIN, :SALIDA_EMERGENCIA, 
        :VIDEOVIGILANCIA_OBS, :PROHIBIDO_FUMAR_OBS, :PTM_OBS, :CAMBIO_MAXIMO_OBS, :TARIFAS_OBS, :OCUPACION_MAXIMA_OBS, :BOTIQUIN_OBS, :SALIDA_EMERGENCIA_OBS)";
    ...
    private static function insertarPegatinasInteriorCentral($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_int_central` (`ID`, `TARIFAS`, `PLAN_EVACUACION`, `COVID`, `QR_ENCUESTA`, `TARIFAS_OBS`, 
        `PLAN_EVACUACION_OBS`, `COVID_OBS`, `QR_ENCUESTA_OBS`) VALUES (NULL, :TARIFAS, :PLAN_EVACUACION, :COVID, :QR_ENCUESTA, 
        :TARIFAS_OBS, :PLAN_EVACUACION_OBS, :COVID_OBS, :QR_ENCUESTA_OBS)";
    ...
    private static function insertarPegatinasLunaInterior($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_int_luna` (`ID`, `CINTURON_SEGURIDAD`, `MARTILLOS`, `EXTINTORES`, 
        `CINTURON_SEGURIDAD_OBS`, `MARTILLOS_OBS`, `EXTINTORES_OBS`) VALUES (NULL, :CINTURON_SEGURIDAD, :MARTILLOS, :EXTINTORES, 
        :CINTURON_SEGURIDAD_OBS, :MARTILLOS_OBS, :EXTINTORES_OBS)";
    ...
    private static function insertarPegatinasInteriorMampara($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_int_mampara` (`ID`, `TARIFAS`, `PERRO_GUIA`, `ZONA_RESERVADA_PMR`, `TELEFONO_OPERADOR`, `WEB_CRTM`, 
        `WEB_EMPRESA`, `TARIFAS_OBS`, `PERRO_GUIA_OBS`, `ZONA_RESERVADA_PMR_OBS`, `TELEFONO_OPERADOR_OBS`, `WEB_CRTM_OBS`, `WEB_EMPRESA_OBS`) 
        VALUES (NULL, :TARIFAS, :PERRO_GUIA, :ZONA_RESERVADA_PMR, :TELEFONO_OPERADOR, :WEB_CRTM, :WEB_EMPRESA, :TARIFAS_OBS, :PERRO_GUIA_OBS, :ZONA_RESERVADA_PMR_OBS, 
        :TELEFONO_OPERADOR_OBS, :WEB_CRTM_OBS, :WEB_EMPRESA_OBS)";
    ...
    private static function insertarPegatinasInteriorTrasera($datos)
    {
        ...
        $queryFlota = " INSERT INTO `peg_int_trasera` (`ID`, `MARTILLO`, `PROHIBIDO_FUMAR`, `PMR`, `VIDEOVIGILANCIA`, `MARTILLO_OBS`, 
        `PROHIBIDO_FUMAR_OBS`, `PMR_OBS`, `VIDEOVIGILANCIA_OBS`) VALUES (NULL, :MARTILLO, :PROHIBIDO_FUMAR, :PMR, :VIDEOVIGILANCIA, 
        :MARTILLO_OBS, :PROHIBIDO_FUMAR_OBS, :PMR_OBS, :VIDEOVIGILANCIA_OBS)";
